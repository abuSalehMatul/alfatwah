      ...
      <div class="col-md-12 col-sm-12 col-12">
        <div class="white-box">
          ...
          <div class="col-md-12 col-sm-6 form-group d-flex">
            <div
              class="col-md-8 col-sm-8 col-12 pl-0 pr-md-2 pr-0 pr-sm-2 pr-xl-2"
            >
...
export default {
  ...
  methods: {
    saveArticle() {
      ...
      if (
        typeof this.article_edit != "undefined" &&
        this.article_edit == "yes"
      ) {
        data.append("article_id", this.article_id);
        ifEdit = 1;
      }
      axios
        .post(this.save_article, data)
        .then((res) => {
          if (ifEdit == 0) window.location.href = res.data;
    ...
    getArticle(id) {
      axios.get("/admin/api/article/" + id).then((res) => {
        console.log(res);
