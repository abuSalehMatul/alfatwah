...
<body>
    ...
    <h1>Hello</h1>, 
    <p>We AlFatawa Alhanafia received an attempt for registration with your email address.</p>
     ...
     <br>
     <br>
     <p>This is an automatic email, please ignore this if that wasn't you. <a href="{{url('/')}}"></a></p>
